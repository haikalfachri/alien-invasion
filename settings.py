class Settings:
    ...
    def __init__(self):
        ...
        #Bullet settings
        self.bullet_speed = 0.2 #1.5
        self.bullet_width = 10 #3
        self.bullet_height = 10 #15
        self.bullet_color = (255, 0, 0) #(60, 60, 60)
        self.bullets_allowed = 3 #3

        #Alien settings
        self.alien_speed = 0.6 #0.5
        self.fleet_drop_speed = 10.5 #10
